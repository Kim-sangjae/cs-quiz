...
const FEATURES = [
  ...
  },
  {
    icon: '🏆',
    title: '레벨 & 업적 시스템',
    desc: '퀴즈 풀이·출석·문제 등록·대전 등 활동으로 경험치를 모아 최대 200레벨까지 성장합니다. 카테고리별로는 입문 → 학습 → 숙련 → 마스터 단계로 올라가며, 다양한 활동 배지를 수집할 수 있습니다.',
  },
  {
    icon: '📊',
    title: '마이페이지 분석',
    desc: '카테고리별 정답률·단계·약점 카테고리 진단, 점수 추이 그래프, 출석 달력, 이번 주 통계 요약 제공.',
  },
];
