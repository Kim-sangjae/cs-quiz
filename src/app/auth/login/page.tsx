  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <p className="text-sm text-neutral-400 mb-8">
        소셜 계정으로 로그인하여 서비스를 이용해주세요.
      </p>
      <div className="flex flex-col gap-3">
        <button
          onClick={() => signIn('google', { callbackUrl })}
          className="w-full flex items-center justify-center gap-3 rounded-md bg-white text-black text-sm font-medium px-6 py-3 hover:bg-neutral-200 transition-colors"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-md text-black text-sm font-medium px-6 py-3 hover:opacity-90 transition-opacity"
